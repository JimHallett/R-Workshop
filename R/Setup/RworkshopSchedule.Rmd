...
- The number of packages for handling, visualising, and analysing data is phenomena
...
- Extensible
- The community of users is generally helpful
...
- Much R code is written to solve an immediate problem, so may not be readily understandable
- Because of the focus on problem-solving, the processes of software development may be ignored
